...
function sero () {
    return (
        <>
            <div className=" h-[755px] bg-[#FAF7FC]  flex items-center justify-center flex-col max-md:h-[1533px]">
                <h2 className=" w-[571px] font-Raleway font-semibold text-[56px]  leading-[66px] tracking-[-3px]   mr-[35rem] max-md:mr-0 max-md:w-[325px]">Mind blowing Features</h2>
                <p className=" w-[571px]  font-medium text-[19.2px] leading-[27.5px]  font-Raleway mt-[25.5px] mr-[35rem] max-md:w-[325px] max-md:mr-0">Powering value, equality, access to education, and ending poverty by creating opportunities and jobs for Africa’s young and creative generation.</p>
