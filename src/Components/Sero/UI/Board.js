...
function Board({image, text1, text2}) {
    return (
        <div className="border-2 border-[#F3E1FF] w-[361px] h-[340px] pt-[51.05px] pl-[29.48px] pr-[20.32px] pb-[40.5px] rounded-[9.50833px] bg-[#FFFF] hover:bg-[#E9DAFE]  max-md:w-[333px] max-md:h-[321px] max-md:pl-[23px]   max-lg:w-[550px] max-md:pt-[38px] ">
