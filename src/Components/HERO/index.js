...
const Hero = () => {
  return (
    <>
    <div className="flex h-[950px]  justify-between pl-36 pt-[115px] bg-purple   max-md:pl-[28px] max-md:pr-[27.5px] max-md:pt-12  max-lg:pl-12 max-lg:pt-[80px] max-lg:flex-col max-md:h-[70rem] max-lg:h-[90rem] max-md:justify-start">
