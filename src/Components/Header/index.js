        ...
        <>
            ...
            <div className="flex h-[935.5px] pl-36 pt-[115px] bg-purple   max-md:pl-[28px] max-md:pr-[27.5px] max-md:pt-12  max-lg:pl-12 max-lg:pt-[80px] max-lg:flex-col max-md:h-[73rem] max-lg:h-[90rem]">
                ...
                <div>
                    ...
                    <p className="font-Raleway  font-medium pt-[31.5px] text-xl text-[#E8E7E8]        max-md:pt-[26.5px] "> Deliver <span className="italic font-extrabold text-xl">Free Pass <span className="border-l-2 ml-2 mr-2"></span> Zero-Rated .</span> </p>
                ...
                <div className="relative">
                    ...
                    <img src={light} alt="" className="absolute top-[25rem] left-6    max-md:hidden  max-lg:hidden " />
